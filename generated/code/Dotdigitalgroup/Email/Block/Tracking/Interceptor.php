...
class Interceptor extends \Dotdigitalgroup\Email\Block\Tracking implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isPageTrackingAvailable');
        return $pluginInfo ? $this->___callPlugins('isPageTrackingAvailable', func_get_args(), $pluginInfo) : parent::isPageTrackingAvailable();
    }
    ...
    public function getPageTrackingUrl()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getPageTrackingUrl', func_get_args(), $pluginInfo) : parent::getPageTrackingUrl();
    }
