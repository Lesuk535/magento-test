...
class Interceptor extends \Dotdigitalgroup\Email\Block\EmailCapture\EmailCapture implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getEmailCaptureUrl()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getEmailCaptureUrl', func_get_args(), $pluginInfo) : parent::getEmailCaptureUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isWebBehaviourTrackingEnabled');
        return $pluginInfo ? $this->___callPlugins('isWebBehaviourTrackingEnabled', func_get_args(), $pluginInfo) : parent::isWebBehaviourTrackingEnabled();
    }
