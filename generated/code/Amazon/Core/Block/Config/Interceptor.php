...
class Interceptor extends \Amazon\Core\Block\Config implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isBadgeEnabled');
        return $pluginInfo ? $this->___callPlugins('isBadgeEnabled', func_get_args(), $pluginInfo) : parent::isBadgeEnabled();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isExtensionEnabled');
        return $pluginInfo ? $this->___callPlugins('isExtensionEnabled', func_get_args(), $pluginInfo) : parent::isExtensionEnabled();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'sanitizePaymentAction');
        return $pluginInfo ? $this->___callPlugins('sanitizePaymentAction', func_get_args(), $pluginInfo) : parent::sanitizePaymentAction();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'transformSandboxSimulationOptions');
        return $pluginInfo ? $this->___callPlugins('transformSandboxSimulationOptions', func_get_args(), $pluginInfo) : parent::transformSandboxSimulationOptions();
    }
