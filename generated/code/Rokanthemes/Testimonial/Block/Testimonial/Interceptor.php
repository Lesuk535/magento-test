<?php
namespace Rokanthemes\Testimonial\Block\Testimonial;

/**
 * Interceptor class for @see \Rokanthemes\Testimonial\Block\Testimonial
 */
class Interceptor extends \Rokanthemes\Testimonial\Block\Testimonial implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Rokanthemes\Testimonial\Model\TestimoFactory $testimoFactory, \Rokanthemes\Testimonial\Model\ResourceModel\Testimo\CollectionFactory $testimoCollectionFactory, \Magento\Customer\Model\Session $customerSession, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $testimoFactory, $testimoCollectionFactory, $customerSession, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTestimonial');
        return $pluginInfo ? $this->___callPlugins('getTestimonial', func_get_args(), $pluginInfo) : parent::getTestimonial();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIdStore');
        return $pluginInfo ? $this->___callPlugins('getIdStore', func_get_args(), $pluginInfo) : parent::getIdStore();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMediaFolder');
        return $pluginInfo ? $this->___callPlugins('getMediaFolder', func_get_args(), $pluginInfo) : parent::getMediaFolder();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'checklogin');
        return $pluginInfo ? $this->___callPlugins('checklogin', func_get_args(), $pluginInfo) : parent::checklogin();
    }
