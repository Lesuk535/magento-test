...
class Interceptor extends \Rokanthemes\BestsellerProduct\Block\Bestseller implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getConfig($att)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getConfig', func_get_args(), $pluginInfo) : parent::getConfig($att);
    }

    /**
     * {@inheritdoc}
     */
    public function cut_string_featuredproduct($string, $number)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'cut_string_featuredproduct');
        return $pluginInfo ? $this->___callPlugins('cut_string_featuredproduct', func_get_args(), $pluginInfo) : parent::cut_string_featuredproduct($string, $number);
    }
