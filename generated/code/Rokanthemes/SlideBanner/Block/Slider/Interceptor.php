<?php
namespace Rokanthemes\SlideBanner\Block\Slider;

/**
 * Interceptor class for @see \Rokanthemes\SlideBanner\Block\Slider
 */
class Interceptor extends \Rokanthemes\SlideBanner\Block\Slider implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Rokanthemes\SlideBanner\Model\SliderFactory $sliderFactory, \Rokanthemes\SlideBanner\Model\SlideFactory $slideFactory, \Magento\Cms\Model\Template\FilterProvider $filterProvider, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $sliderFactory, $slideFactory, $filterProvider, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImageElement');
        return $pluginInfo ? $this->___callPlugins('getImageElement', func_get_args(), $pluginInfo) : parent::getImageElement($src);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBannerCollection');
        return $pluginInfo ? $this->___callPlugins('getBannerCollection', func_get_args(), $pluginInfo) : parent::getBannerCollection();
    }
    ...
    public function getSlider()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getSlider', func_get_args(), $pluginInfo) : parent::getSlider();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getContentText');
        return $pluginInfo ? $this->___callPlugins('getContentText', func_get_args(), $pluginInfo) : parent::getContentText($html);
    }
