<?php
namespace Rokanthemes\Blog\Block\Sidebar\Recent;

/**
 * Interceptor class for @see \Rokanthemes\Blog\Block\Sidebar\Recent
 */
class Interceptor extends \Rokanthemes\Blog\Block\Sidebar\Recent implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Framework\Registry $coreRegistry, \Magento\Cms\Model\Template\FilterProvider $filterProvider, \Rokanthemes\Blog\Model\ResourceModel\Post\CollectionFactory $postCollectionFactory, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $coreRegistry, $filterProvider, $postCollectionFactory, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPostCollection');
        return $pluginInfo ? $this->___callPlugins('getPostCollection', func_get_args(), $pluginInfo) : parent::getPostCollection();
    }
