<?php
namespace Rokanthemes\Themeoption\Block\Themeoption;

/**
 * Interceptor class for @see \Rokanthemes\Themeoption\Block\Themeoption
 */
class Interceptor extends \Rokanthemes\Themeoption\Block\Themeoption implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getConfig($config_path, $storeCode = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getConfig', func_get_args(), $pluginInfo) : parent::getConfig($config_path, $storeCode);
    }
