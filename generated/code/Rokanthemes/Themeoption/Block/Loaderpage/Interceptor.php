<?php
namespace Rokanthemes\Themeoption\Block\Loaderpage;

/**
 * Interceptor class for @see \Rokanthemes\Themeoption\Block\Loaderpage
 */
class Interceptor extends \Rokanthemes\Themeoption\Block\Loaderpage implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getConfig($storeCode = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getConfig', func_get_args(), $pluginInfo) : parent::getConfig($storeCode);
    }
