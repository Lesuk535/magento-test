<?php
namespace Rokanthemes\Brand\Block\Widget\Brandlist;

/**
 * Interceptor class for @see \Rokanthemes\Brand\Block\Widget\Brandlist
 */
class Interceptor extends \Rokanthemes\Brand\Block\Widget\Brandlist implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Framework\Registry $registry, \Rokanthemes\Brand\Helper\Data $brandHelper, \Rokanthemes\Brand\Model\Brand $brandCollection, \Magento\Cms\Model\Block $blockModel, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $registry, $brandHelper, $brandCollection, $blockModel, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCmsBlockModel');
        return $pluginInfo ? $this->___callPlugins('getCmsBlockModel', func_get_args(), $pluginInfo) : parent::getCmsBlockModel();
    }
    ...
    public function _toHtml()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('_toHtml', func_get_args(), $pluginInfo) : parent::_toHtml();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBrandCollection');
        return $pluginInfo ? $this->___callPlugins('getBrandCollection', func_get_args(), $pluginInfo) : parent::getBrandCollection();
    }
    ...
    public function getConfig($key, $default = '')
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getConfig', func_get_args(), $pluginInfo) : parent::getConfig($key, $default);
    }
