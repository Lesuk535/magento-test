<?php
namespace Rokanthemes\CustomMenu\Block\Topmenu;

/**
 * Interceptor class for @see \Rokanthemes\CustomMenu\Block\Topmenu
 */
class Interceptor extends \Rokanthemes\CustomMenu\Block\Topmenu implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Catalog\Helper\Category $categoryHelper, \Rokanthemes\CustomMenu\Helper\Data $helper, \Magento\Catalog\Model\Indexer\Category\Flat\State $categoryFlatState, \Magento\Catalog\Model\CategoryFactory $categoryFactory, \Magento\Theme\Block\Html\Topmenu $topMenu, \Magento\Cms\Model\Template\FilterProvider $filterProvider, \Magento\Cms\Model\BlockFactory $blockFactory, \Magento\Framework\View\Element\Context $viewContext)
    {
        $this->___init();
        parent::__construct($context, $categoryHelper, $helper, $categoryFlatState, $categoryFactory, $topMenu, $filterProvider, $blockFactory, $viewContext);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCustomMenuConfig');
        return $pluginInfo ? $this->___callPlugins('getCustomMenuConfig', func_get_args(), $pluginInfo) : parent::getCustomMenuConfig();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryHelper');
        return $pluginInfo ? $this->___callPlugins('getCategoryHelper', func_get_args(), $pluginInfo) : parent::getCategoryHelper();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryModel');
        return $pluginInfo ? $this->___callPlugins('getCategoryModel', func_get_args(), $pluginInfo) : parent::getCategoryModel($id);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getChildCategories');
        return $pluginInfo ? $this->___callPlugins('getChildCategories', func_get_args(), $pluginInfo) : parent::getChildCategories($category);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getActiveChildCategories');
        return $pluginInfo ? $this->___callPlugins('getActiveChildCategories', func_get_args(), $pluginInfo) : parent::getActiveChildCategories($category);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTemplatePath');
        return $pluginInfo ? $this->___callPlugins('getTemplatePath', func_get_args(), $pluginInfo) : parent::getTemplatePath();
    }
