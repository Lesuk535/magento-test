...
class Interceptor extends \Magento\Paypal\Block\Express\InContext\Component implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getMerchantId()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getMerchantId', func_get_args(), $pluginInfo) : parent::getMerchantId();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isButtonContext');
        return $pluginInfo ? $this->___callPlugins('isButtonContext', func_get_args(), $pluginInfo) : parent::isButtonContext();
    }
