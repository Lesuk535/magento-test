...
class Interceptor extends \Magento\Customer\Block\SectionConfig implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getSections()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getSections', func_get_args(), $pluginInfo) : parent::getSections();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getClientSideSections');
        return $pluginInfo ? $this->___callPlugins('getClientSideSections', func_get_args(), $pluginInfo) : parent::getClientSideSections();
    }
