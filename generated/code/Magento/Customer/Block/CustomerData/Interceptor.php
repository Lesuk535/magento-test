...
class Interceptor extends \Magento\Customer\Block\CustomerData implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getExpirableSectionLifetime');
        return $pluginInfo ? $this->___callPlugins('getExpirableSectionLifetime', func_get_args(), $pluginInfo) : parent::getExpirableSectionLifetime();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getExpirableSectionNames');
        return $pluginInfo ? $this->___callPlugins('getExpirableSectionNames', func_get_args(), $pluginInfo) : parent::getExpirableSectionNames();
    }
