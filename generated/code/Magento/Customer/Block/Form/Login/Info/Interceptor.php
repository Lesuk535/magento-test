...
class Interceptor extends \Magento\Customer\Block\Form\Login\Info implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRegistration');
        return $pluginInfo ? $this->___callPlugins('getRegistration', func_get_args(), $pluginInfo) : parent::getRegistration();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCreateAccountUrl');
        return $pluginInfo ? $this->___callPlugins('getCreateAccountUrl', func_get_args(), $pluginInfo) : parent::getCreateAccountUrl();
    }
