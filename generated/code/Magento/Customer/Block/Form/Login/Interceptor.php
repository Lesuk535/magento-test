...
class Interceptor extends \Magento\Customer\Block\Form\Login implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isAutocompleteDisabled');
        return $pluginInfo ? $this->___callPlugins('isAutocompleteDisabled', func_get_args(), $pluginInfo) : parent::isAutocompleteDisabled();
    }
