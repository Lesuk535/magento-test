...
class Interceptor extends \Magento\Customer\Block\CustomerScopeData implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'encodeConfiguration');
        return $pluginInfo ? $this->___callPlugins('encodeConfiguration', func_get_args(), $pluginInfo) : parent::encodeConfiguration($configuration);
    }
