...
class Interceptor extends \Magento\Persistent\Block\Form\Remember implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isRememberMeChecked');
        return $pluginInfo ? $this->___callPlugins('isRememberMeChecked', func_get_args(), $pluginInfo) : parent::isRememberMeChecked();
    }
