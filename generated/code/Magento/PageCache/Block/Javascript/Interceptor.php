...
class Interceptor extends \Magento\PageCache\Block\Javascript implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getScriptOptions');
        return $pluginInfo ? $this->___callPlugins('getScriptOptions', func_get_args(), $pluginInfo) : parent::getScriptOptions();
    }
