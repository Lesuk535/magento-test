...
class Interceptor extends \Magento\Catalog\Block\FrontendStorageManager implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getConfigurationJson');
        return $pluginInfo ? $this->___callPlugins('getConfigurationJson', func_get_args(), $pluginInfo) : parent::getConfigurationJson();
    }
