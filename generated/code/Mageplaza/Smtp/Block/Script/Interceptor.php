<?php
namespace Mageplaza\Smtp\Block\Script;

/**
 * Interceptor class for @see \Mageplaza\Smtp\Block\Script
 */
class Interceptor extends \Mageplaza\Smtp\Block\Script implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Mageplaza\Smtp\Helper\EmailMarketing $helperEmailMarketing, \Magento\Checkout\Model\Session $checkoutSession, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $helperEmailMarketing, $checkoutSession, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHelperEmailMarketing');
        return $pluginInfo ? $this->___callPlugins('getHelperEmailMarketing', func_get_args(), $pluginInfo) : parent::getHelperEmailMarketing();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isSuccessPage');
        return $pluginInfo ? $this->___callPlugins('isSuccessPage', func_get_args(), $pluginInfo) : parent::isSuccessPage();
    }
