...
class Interceptor extends \Mageplaza\GoogleRecaptcha\Block\Captcha implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Mageplaza\GoogleRecaptcha\Helper\Data $helperData, \Magento\Framework\View\Design\Theme\ThemeProviderInterface $themeProvider, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $helperData, $themeProvider, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getForms');
        return $pluginInfo ? $this->___callPlugins('getForms', func_get_args(), $pluginInfo) : parent::getForms();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'unsetDataFromId');
        return $pluginInfo ? $this->___callPlugins('unsetDataFromId', func_get_args(), $pluginInfo) : parent::unsetDataFromId($item, $text);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getInvisibleKey');
        return $pluginInfo ? $this->___callPlugins('getInvisibleKey', func_get_args(), $pluginInfo) : parent::getInvisibleKey();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getVisibleKey');
        return $pluginInfo ? $this->___callPlugins('getVisibleKey', func_get_args(), $pluginInfo) : parent::getVisibleKey();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPositionFrontend');
        return $pluginInfo ? $this->___callPlugins('getPositionFrontend', func_get_args(), $pluginInfo) : parent::getPositionFrontend();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isCaptchaFrontend');
        return $pluginInfo ? $this->___callPlugins('isCaptchaFrontend', func_get_args(), $pluginInfo) : parent::isCaptchaFrontend();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getThemeFrontend');
        return $pluginInfo ? $this->___callPlugins('getThemeFrontend', func_get_args(), $pluginInfo) : parent::getThemeFrontend();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRecaptchaType');
        return $pluginInfo ? $this->___callPlugins('getRecaptchaType', func_get_args(), $pluginInfo) : parent::getRecaptchaType();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isAgeVerificationEnabled');
        return $pluginInfo ? $this->___callPlugins('isAgeVerificationEnabled', func_get_args(), $pluginInfo) : parent::isAgeVerificationEnabled($storeId);
    }
    ...
    public function getCurrentTheme()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getCurrentTheme', func_get_args(), $pluginInfo) : parent::getCurrentTheme();
    }
